...
class PhotoOrganizerFrame (wx.Frame):
    ...
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title=wx.EmptyString, pos=wx.DefaultPosition,
                          size=wx.Size(1178, 866), style=wx.DEFAULT_FRAME_STYLE | wx.TAB_TRAVERSAL)
        ...
        self.PreferencesButton = wx.MenuItem(self.optionsMenu, wx.ID_ANY, u"Preferences",
        ...
        self.TagTree = wx.TreeCtrl(self.m_panel9, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize,
                                   wx.TR_DEFAULT_STYLE | wx.TR_HIDE_ROOT | wx.TR_MULTIPLE)
        ...
        self.DetailsWindow = wx.html.HtmlWindow(self.m_panel11, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize,
        ...
        FilterBoxChoices = []
        self.FilterBox = wx.ComboBox(self.m_panel5, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize,
                                     FilterBoxChoices, wx.TE_PROCESS_ENTER)
        ...
        self.thumbPreviewSplitter = wx.SplitterWindow(self.m_panel5, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize,
                                                      wx.SP_3D)
        self.thumbPreviewSplitter.Bind(wx.EVT_IDLE, self.thumbPreviewSplitterOnIdle)

        self.ThumbnailScroller = wx.ScrolledWindow(self.thumbPreviewSplitter, wx.ID_ANY, wx.DefaultPosition,
                                                   wx.DefaultSize, wx.HSCROLL | wx.VSCROLL)
        self.ThumbnailScroller.SetScrollRate(5, 5)
        bSizer21 = wx.BoxSizer(wx.VERTICAL)

        self.thumbnailGrid = wx.ListCtrl(self.ThumbnailScroller, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize,
                                         wx.LC_EDIT_LABELS | wx.LC_ICON | wx.LC_NO_HEADER)
        ...
        self.PreviewPanel = wx.Panel(self.thumbPreviewSplitter, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize,
                                     wx.TAB_TRAVERSAL)
        bSizer9 = wx.BoxSizer(wx.HORIZONTAL)

        self.Preview = wx.StaticBitmap(self.PreviewPanel, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition,
                                       wx.DefaultSize, 0)
